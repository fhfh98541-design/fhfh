<iframe src="https://renia213523.github.io/commission/" style="width:100%; height:800px; border:none;" frameborder="0" scrolling="yes"></iframe>
...
<div class="main-scroll-wrapper" id="scroll-area">
    <nav class="nav-bar">
        <a href="#process" class="nav-link">PROCESS</a> <a href="#price" class="nav-link">PRICE</a> <a href="#work" class="nav-link active">WORK</a> <a href="#notice" class="nav-link">NOTICE</a> <a href="#order" class="nav-link">ORDER</a>
    </nav>
